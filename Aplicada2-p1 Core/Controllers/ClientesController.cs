...
namespace Aplicada2p1Core.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(Aplicada2P1Db context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCliente,FechaNacimiento,Nombres,CatidadTelefonos")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCliente,FechaNacimiento,Nombres,CatidadTelefonos")] Clientes clientes)
        {
